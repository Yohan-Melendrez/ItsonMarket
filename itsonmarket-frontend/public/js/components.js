class NavbarComponent extends HTMLElement {
            ...
            <nav class="navbar">
                <div class="navbar-container">
                    <a href="#/publicaciones" class="navbar-brand">
                        <img src="/imgs/ItsonMarket.png" alt="ITSON Market" style="height: 45px; border-radius: 8px;">
                    </a>
                    
                    <ul class="navbar-menu" id="nav-main-menu">
                        <li>
                    ...
                    <div class="navbar-user ${isLoggedIn ? '' : 'hidden'}" id="nav-user-menu">
                        <div class="dropdown">
                            <div class="navbar-user-info" id="dropdown-trigger">
                                <img src="${user.foto || '/imgs/default-avatar.svg'}" alt="Avatar" class="navbar-avatar" id="user-avatar">
                                <span id="user-name">${user.nombre || 'Usuario'}</span>
                    ...
                    <div class="navbar-user ${isLoggedIn ? 'hidden' : ''}" id="nav-auth-links">
                ...
                <div class="navbar-menu hidden" id="mobile-menu">
                    <a href="#/publicaciones">Explorar</a>
                    <a href="#/publicaciones/crear">Publicar</a>
    ...
    updateAuthState() {
        ...
        const userMenu = this.querySelector('#nav-user-menu');
        const authLinks = this.querySelector('#nav-auth-links');
...
class PublicacionCard extends HTMLElement {
    ...
    render() {
        ...
        this.innerHTML = `
            <div class="publicacion-card card" data-id="${id}">
                <div class="publicacion-card-imagen">
                    <img src="${imagen}" alt="${titulo}" onerror="this.src='/imgs/default-product.svg'">
                    ${tipo === 'servicio' ? '<span class="badge badge-accent publicacion-badge">Servicio</span>' : ''}
                    ${estado === 'vendido' ? '<div class="publicacion-vendido"><span class="badge badge-error">Vendido</span></div>' : ''}
                </div>
                <div class="publicacion-card-body">
                    <p class="publicacion-categoria">${categoria}</p>
                    <h3 class="publicacion-titulo">${titulo}</h3>
                    <p class="publicacion-descripcion">${descripcion}</p>
                    <div class="publicacion-footer">
                        <span class="publicacion-precio">${precioFormateado}</span>
                        <span class="publicacion-fecha">${fechaFormateada}</span>
                    </div>
                </div>
            </div>
        `;
    ...
    setupEventListeners() {
        const card = this.querySelector('.publicacion-card');
        if (card) {
